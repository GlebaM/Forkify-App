...
var _stable = require("core-js/stable"); //Polfifilling arrays etc.
...
const showRecipe = async function() {
    try {
        ...
        console.log(res);
        console.log(data);
        if (!res.ok) throw new Error(`O kurde!!! Podałeś zły adres!!! Real cause: ${data.message}, and response status is ${res.status}`);
...
},{}]},["drOo7","jKMjS"], "jKMjS", "parcelRequire6d3a")
